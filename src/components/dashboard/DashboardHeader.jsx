...
export default function DashboardHeader() {
  ...
  // 2. Auto-select first account if none is currently selected
  useEffect(() => {
  ...
  // 3. Subscribe to trades for the selected account
  useEffect(() => {
  ...
  return (
    <header className="dashboard-header-container">
      ...
      {/* Filter and Control Bar — shown for ALL accounts.
          RR tabs and Optimize are Backtest-only. */}
      <div className="filter-toolbar">
        ...
        <div className="filter-toolbar-section filter-actions-group">
          ...
          <button
            type="button"
            className="btn-toolbar btn-session"
          ...
          <button
            type="button"
            className="btn-toolbar btn-limits"
          ...
          {isBacktest && (
            <button
              type="button"
              className="btn-toolbar btn-optimize"
